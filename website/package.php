...
<section class="header">
    <a href="about.html" class="logo">travel</a>
    <nav class="navbar">
...
<section class="footer">
    <div class="box-container">
        <div class="box">
            ...
            <a href="book.php"> <i class="fas fa-angle-right"></i><i class="i.fas.fa-angle-right"></i> book</a>            
        </div>
        <div class="box">
            <h3>Extra Links</h3>
    ...
    <div class="credit">created by <span>ms. web designer</span> | all rights resered! | </div>
</section>
